...
namespace FoxTool.Fox.Enum
{
    public class TppLensFlareShapeDistanceScalingMode : FoxSwitch
    {
        ...
        public static readonly FoxEnumValue DistanceScalingModeSizescale = new FoxEnumValue("DISTANCE_SCALING_MODE_SIZESCALE", 1);
        public static readonly FoxEnumValue DistanceScalingModeAlphascale = new FoxEnumValue("DISTANCE_SCALING_MODE_ALPHASCALE", 2);
        public static readonly FoxEnumValue DistanceScalingModeSizescale2 = new FoxEnumValue("DISTANCE_SCALING_MODE_SIZESCALE2", 3);
